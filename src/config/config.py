...
class Config:
    ...
    def get_notification_filters(self) -> List[NotificationFilterConfig]:
        return self._fetch_config("filters/", NotificationFilterConfig.from_dict)

    def _fetch_config(self, prefix: str, mapper: Callable[[Dict[str, str]], T]) -> List[T]:
