...
item_1 = findings(item="item_1", findings={"finding 1"})
item_2 = findings(item="item_2", findings={"finding 2"})
item_3 = findings(item="item_3")
item_4 = findings(item="item_4", findings={"finding 3"})
