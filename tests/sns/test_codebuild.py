...
def test_event_to_findings() -> None:
    ...
    expected_build_url = (
        "url : https://eu-west-2.console.aws.amazon.com/codesuite/codebuild/123456789012/projects/"
        "ua-test/build/ua-test%3A7cf9f577-4069-4010-a467-f0640dfc0afb/?region=eu-west-2"
    )
    assert finding.findings == frozenset({expected_build_url, expected_logs_link})
